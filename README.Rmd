...
# splitting data into training set and set set with 80-20 split
sample_size<-floor(0,8*nrow(train))
trainind<-sample(seq_len(nrow(train)), size=sample_size)
...
After fitting the logistic regression model using the training data, I use the model with the test data to predict the CDR (Dementia rating, either 0 or 1). The results of the prediction is shown in the confusion matrix. Accuracy of 84% was achieved with logistic regression.
